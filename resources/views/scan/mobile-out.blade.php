      ...
      <div class="flex items-center justify-between gap-3">
        <div>
          <h1 class="text-lg sm:text-xl font-extrabold text-slate-900 dark:text-slate-100">
            Scan Mobile (PDT)
            <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded-full border text-[10px] font-black tracking-widest uppercase bg-amber-50 border-amber-200 text-amber-700 dark:bg-amber-950/30 dark:border-amber-900/60 dark:text-amber-200">OUT</span>
          </h1>
