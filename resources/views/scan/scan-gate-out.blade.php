        ...
        <div class="flex items-start gap-3">
          ...
          <div>
            <h1 class="text-xl md:text-2xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100">
              Scan Gate
              <span class="ml-2 inline-flex items-center px-2.5 py-1 rounded-full border text-[11px] font-black tracking-widest uppercase bg-amber-50 border-amber-200 text-amber-700 dark:bg-amber-950/30 dark:border-amber-900/60 dark:text-amber-200">OUT</span>
            </h1>
