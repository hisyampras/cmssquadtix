    ...
    <div class="rounded-3xl border border-slate-200/70 bg-white/75 backdrop-blur supports-[backdrop-filter]:bg-white/60
      ...
      <div class="p-5 md:p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h1 class="text-xl md:text-2xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100">Create Event</h1>
            <p class="text-sm text-slate-500 mt-1 dark:text-slate-400">Buat event baru untuk kebutuhan scan & ticketing.</p>
          </div>
        </div>
      ...
      <form method="POST" action="{{ route('events.store') }}" class="p-5 md:p-6 space-y-5">
        ...
        <div>
          ...
          <input name="name"
                 ...
                 placeholder="Contoh: Annual Gathering 2026"
                 required>
        ...
        <div class="flex items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4
          ...
          <div>
            ...
            <div class="text-sm text-slate-500 dark:text-slate-400">Event aktif dapat digunakan untuk scan & ticketing.</div>
          </div>
